...
Poodles is composed of 3 functions that clean the data, make a data frame of just poodles, and find poodles as a percent of total dogs in each zip code. 
...
This function uses the outputs from both the first and second function and constructs poodles as a percentage of the total dogs in each zip code. The zip codes are sorted in order of decreasing percentage so that the first row has the highest poodle percent.
